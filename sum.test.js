...
// toBe() is a matcher provided by Jest that checks if the value is strictly equal to the expected value. It is used to compare primitive values (numbers, strings, booleans) and checks for strict equality (===).
// For Non-primitive values (objects, arrays), toEqual() should be used instead of toBe() to check for deep equality.
